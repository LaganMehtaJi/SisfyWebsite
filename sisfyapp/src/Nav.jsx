function Nav(){
    return(
        ...
        <div style={{boxShadow:" 1px 1px 8px gray",width:"960px",height:"62px",display:"flex" ,gap:"70px",marginLeft:"200px",marginTop:"20px",border:"none" ,borderRadius:"25px"}}>
            ...
            <div style={{width:"65px",padding:"17px"}}>
            ...
            <div style={{width:"40px",padding:"17px"}}>
                <span style={{fontSize:"17px",fontFamily:"sans-serif"}}>FAQs</span>
                <hr style={{color:"blue"}}/>
            </div>
            </article>
            <button style={{marginTop:"5px",height:"50px",padding:"17px",width:"150px",backgroundColor:"black",color:"white",border:"none",borderRadius:"12px",fontWeight:"bold",fontSize:"17cpx"}}>
                Chat
            </button>
        </div>
